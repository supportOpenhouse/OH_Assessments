...
declare
  ...
  fix_note constant text :=
    'Run inspect.sql to see what is there and how many rows it holds. '
    || 'If none of it is real candidate data: reset.sql (DESTRUCTIVE), '
    || 'then schema.sql, then seed_oh_users.sql.';
begin
